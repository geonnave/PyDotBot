...
import { BotState, Bounds, LH2Position, LINK_LABEL, STATE_ORDER, UnifiedBot } from "./types";
...
export const Footer: React.FC<FooterProps> = (props) => {
  ...
  return (
    ...
    >
      <Minimap bots={props.bots} bounds={props.bounds} cam={props.cam} setCam={props.setCam} geom={props.geom} />
